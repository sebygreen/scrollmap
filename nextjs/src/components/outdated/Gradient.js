...
export default function Canvas() {
    ...
    return <canvas className={styles.gradient} id="gradientCanvas" />;
}
...
export class Gradient {
    constructor(...t) {
        e(this, "el", void 0),
            ...
            e(this, "last", 0),
            e(this, "width", void 0),
            e(this, "minWidth", 1111), // 1111
            e(this, "height", 400), // 600
    ...
    shouldSkipFrame(e) {
        return; /* !!window.document.hidden || !this.conf.playing || parseInt(e, 10) % 2 == 0 || void 0 */ //this slows down the animation. don't know why
    }
    updateFrequency(e) {
