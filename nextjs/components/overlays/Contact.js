        ...
        <Portal selector="#modalRoot">
            <Overlay title="Contact" onClose={onClose}>
                <div className={styles.announcement}>
                    ...
                    <p>
                        Since the 1<sup>st</sup> of January 2021 website maintenance is being taken care of by Sebastien
                        Green. The below contact methods have been updated accordingly.
                    </p>
                </div>
                <div className={styles.announcement}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.socials}>
                        ...
                        />
                        <Social
                            href="https://twitter.com/sebygreen"
                            text="sebygreen"
                            icon={
                        ...
                        />
                        <Social
                            href="https://linkedin.com/in/sebastiengreen"
                            text="Sebastien Green"
                            icon={
                        ...
                        />
                        <Social
                            href="mailto:sebastien@smkg.me"
                            text="sebastien@smkg.me"
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
